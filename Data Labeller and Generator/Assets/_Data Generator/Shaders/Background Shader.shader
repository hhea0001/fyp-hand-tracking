...
Shader "Background Shader"
{
	Properties
	{
		...
		[ASEEnd][ASEBegin]_HDRIBrightness("HDRI Brightness", Range( 1 , 2)) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			#pragma multi_compile __ _BackgroundIsCubemap
			...
			#endif
			CBUFFER_END
			sampler2D _BackgroundTexture2D;
			float _BackgroundRandom;
			samplerCUBE _BackgroundCubemap;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float temp_output_1_0_g107 = _BackgroundRandom;
				float2 appendResult4_g107 = (float2(temp_output_1_0_g107 , 0.22));
				float dotResult4_g112 = dot( appendResult4_g107 , float2( 12.9898,78.233 ) );
				float lerpResult10_g112 = lerp( 0.9 , 1.1 , frac( ( sin( dotResult4_g112 ) * 43.75855 ) ));
				float2 appendResult5_g107 = (float2(temp_output_1_0_g107 , 0.57));
				float dotResult4_g110 = dot( appendResult5_g107 , float2( 12.9898,78.233 ) );
				float lerpResult10_g110 = lerp( -0.2 , 0.2 , frac( ( sin( dotResult4_g110 ) * 43.75855 ) ));
				float2 appendResult10_g107 = (float2(temp_output_1_0_g107 , 0.978));
				float dotResult4_g109 = dot( appendResult10_g107 , float2( 12.9898,78.233 ) );
				float lerpResult10_g109 = lerp( -0.2 , 0.2 , frac( ( sin( dotResult4_g109 ) * 43.75855 ) ));
				float2 appendResult12_g107 = (float2(lerpResult10_g110 , lerpResult10_g109));
				float2 appendResult16_g107 = (float2(temp_output_1_0_g107 , 2.22));
				float dotResult4_g111 = dot( appendResult16_g107 , float2( 12.9898,78.233 ) );
				float lerpResult10_g111 = lerp( 0.0 , ( 2.0 * PI ) , frac( ( sin( dotResult4_g111 ) * 43.75855 ) ));
				float2 appendResult20_g107 = (float2(temp_output_1_0_g107 , 7.978));
				float dotResult4_g113 = dot( appendResult20_g107 , float2( 12.9898,78.233 ) );
				float lerpResult10_g113 = lerp( -( 0.25 * PI ) , ( 0.25 * PI ) , frac( ( sin( dotResult4_g113 ) * 43.75855 ) ));
				float2 appendResult18_g107 = (float2(temp_output_1_0_g107 , 4.57));
				float dotResult4_g108 = dot( appendResult18_g107 , float2( 12.9898,78.233 ) );
				float lerpResult10_g108 = lerp( ( ( 0.2 * PI ) + -( 0.3 * PI ) ) , ( ( 0.2 * PI ) + ( 0.3 * PI ) ) , frac( ( sin( dotResult4_g108 ) * 43.75855 ) ));
				float3 normalizeResult23_g107 = normalize( WorldPosition );
				float3 rotatedValue28_g107 = RotateAroundAxis( float3( 0,0,0 ), normalizeResult23_g107, float3( 1,0,0 ), lerpResult10_g108 );
				float3 rotatedValue31_g107 = RotateAroundAxis( float3( 0,0,0 ), rotatedValue28_g107, float3( 0,0,1 ), lerpResult10_g113 );
				float3 rotatedValue27_g107 = RotateAroundAxis( float3( 0,0,0 ), rotatedValue31_g107, float3( 0,1,0 ), lerpResult10_g111 );
				#ifdef _BackgroundIsCubemap
				float4 staticSwitch17 = ( texCUBE( _BackgroundCubemap, rotatedValue27_g107 ) * _HDRIBrightness );
				#else
				float4 staticSwitch17 = tex2D( _BackgroundTexture2D, ( ( ( IN.ase_texcoord3.xy - temp_cast_0 ) * lerpResult10_g112 ) + appendResult12_g107 + 0.5 ) );
				#endif
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = staticSwitch17.rgb;
				float Alpha = 1;
...
/*ASEBEGIN
Version=18935
1047;377;1124;686;1489.359;1006.323;2.26735;True;False
Node;AmplifyShaderEditor.SamplerNode;19;-252.6774,-329.8779;Inherit;True;Property;_TextureSample1;Texture Sample 1;1;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Cube;8;0;SAMPLERCUBE;;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;41;97.00861,-232.7922;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.FunctionNode;40;-684.5664,-511.4451;Inherit;False;Random Background UV;-1;;107;1aaffd87421b7304d92e2263e21f06b1;0;1;1;FLOAT;0;False;2;FLOAT2;0;FLOAT3;15
Node;AmplifyShaderEditor.TexturePropertyNode;16;-511.7117,-329.9904;Inherit;True;Global;_BackgroundCubemap;_BackgroundCubemap;1;0;Create;False;0;0;0;False;0;False;None;001cfbb7476f04b48bea124ad07613e2;False;white;LockedToCube;Cube;-1;0;2;SAMPLERCUBE;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.RangedFloatNode;42;-240.9914,-86.79224;Inherit;False;Property;_HDRIBrightness;HDRI Brightness;2;0;Create;True;0;0;0;False;0;False;1;0;1;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;17;190.4884,-406.6902;Inherit;False;Property;_BackgroundIsCubemap;BackgroundIsCubemap;1;0;Create;True;0;0;0;False;0;False;1;0;0;False;;Toggle;2;Key0;Key1;Create;False;True;All;9;1;COLOR;0,0,0,0;False;0;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;4;COLOR;0,0,0,0;False;5;COLOR;0,0,0,0;False;6;COLOR;0,0,0,0;False;7;COLOR;0,0,0,0;False;8;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SamplerNode;18;-266.3117,-781.9895;Inherit;True;Property;_TextureSample0;Texture Sample 0;1;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TexturePropertyNode;15;-501.6125,-781.9904;Inherit;True;Global;_BackgroundTexture2D;_BackgroundTexture2D;0;0;Create;False;0;0;0;False;0;False;None;e099a7f9cce12e04ea49d33c60c27320;False;white;LockedToTexture2D;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
ASEEND*/
//CHKSM=25C85869C3881E4AF161E09BFDD8214066778E45